<?php
  ...
  else
  {
    ...
    $query = mysqli_query($conexion, "SELECT u.nombre, u.username, r.rol
                                      FROM usuarios u
                                      INNER JOIN
                                      rol r
  ...
  <section id="container">
    <div class="form-r">
      ...
      <div class="eliminar-datos">
        <h2>¿Seguro que quieres eliminar el Usuario Seleccionado?</h2>
        <p>Nombre: <span><?php echo $nombre; ?></span></p>
        <p>Usuario: <span><?php echo $usuario; ?></span></p>
        <p>Rol: <span><?php echo $rol; ?></span></p>
        <form class="formulario" action="../php/delete-user.php" method="post">
          <input type="hidden" name="id_usuario" value="<?php echo $id_usuario; ?>">
          <a class="eliminar-btn" href="lista-usuarios.php">Cancelar</a>
