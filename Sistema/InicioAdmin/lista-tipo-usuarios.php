...
<body>
  ...
  <section id="container">
    <div class="lista-f">
      <h3>Actualizacion de Tipo Usuario</h3>
      <hr>
      <table>
        <tr>
          <th>ID</th>
        ...
        <?php
            ...
            $query = mysqli_query($conexion, "SELECT r.id_rol, r.rol
                                              FROM rol r");
            ...
            ?>
              <tr>
                ...
                <td>
                  <a href="actualizar-tipo-usuario.php?id=<?php echo $data['id_rol']; ?>">Actualizar</a> |
                  <a href="eliminar-tipo-usuario.php?id=<?php echo $data['id_rol']; ?>">Eliminar</a>
                </td>
              </tr>
              <?php
                }
