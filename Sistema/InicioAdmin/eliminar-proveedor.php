<?php
  ...
  else
  {
    ...
    $query = mysqli_query($conexion, "SELECT p.nombre, p.apellido, p.telefono, p.direccion
                                      FROM proveedor p
                                      WHERE p.id_proveedor = $id_usuario");
  ...
  <section id="container">
    <div class="form-r">
      ...
      <div class="eliminar-datos">
        <h2>¿Seguro que quieres eliminar el Proveedor Seleccionado?</h2>
        ...
        <form class="formulario" action="../php/delete-proveedor.php" method="post">
          <input type="hidden" name="id_usuario" value="<?php echo $id_usuario; ?>">
          <a class="eliminar-btn" href="lista-proveedores.php">Cancelar</a>
