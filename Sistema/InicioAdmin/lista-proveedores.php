...
<body>
  ...
  <section id="container">
    <div class="lista-f">
      <h3>Actualizacion de Proveedores</h3>
      <hr>
      <table>
        <tr>
          <th>ID</th>
        ...
        <?php
            ...
            $query = mysqli_query($conexion, "SELECT p.id_proveedor, p.nombre, p.apellido, p.telefono, p.direccion
                                              FROM proveedor p");
            ...
            ?>
              <tr>
                ...
                <td>
                  <a href="actualizar-proveedor.php?id=<?php echo $data['id_proveedor']; ?>">Actualizar</a> |
                  <a href="eliminar-proveedor.php?id=<?php echo $data['id_proveedor']; ?>">Eliminar</a>
                </td>
              </tr>
              <?php
                }
