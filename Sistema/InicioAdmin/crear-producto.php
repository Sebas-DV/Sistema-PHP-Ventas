...
<body>
  ...
  <section id="container">
    <div class="form-r">
      ...
      <hr>
        <form class="" action="../php/reg-producto.php" method="post">
          <label for="nombre">Nombre del Producto</label>
          <input type="text" name="nombre" id="nombre" value="">
          <label for="nombre">Precio</label>
          <input type="precio" name="precio" id="precio" value="">
          ...
          <input type="submit" name="" value="Registrar Producto" class="btn-submit">
        </form>
    </div>
  </section>
</body>
