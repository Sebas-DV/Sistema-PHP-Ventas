<?php
  ...
  else
  {
    ...
    $query = mysqli_query($conexion, "SELECT r.rol
                                      FROM rol r
                                      WHERE r.id_rol = $id_usuario");
  ...
  <section id="container">
    <div class="form-r">
      ...
      <div class="eliminar-datos">
        <h2>¿Seguro que quieres eliminar el Tipo Usuario Seleccionado?</h2>
        <p>Tipo Usuario: <span><?php echo $nombre; ?></span></p>
        <form class="formulario" action="../php/delete-tipo-usuario.php" method="post">
          <input type="hidden" name="id_usuario" value="<?php echo $id_usuario; ?>">
          <a class="eliminar-btn" href="lista-tipo-usuarios.php">Cancelar</a>
