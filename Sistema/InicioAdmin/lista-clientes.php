    ...
    <div class="lista-f">
      ...
      <table>
        ...
        <?php
            ...
            $query = mysqli_query($conexion, "SELECT c.id_cliente, c.nombre, c.apellido, c.telefono, c.direccion
                                              FROM cliente c");
            ...
            ?>
              <tr>
                ...
                <td>
                  <a href="actualizar-cliente.php?id=<?php echo $data['id_cliente']; ?>">Actualizar</a> |
                  <a href="eliminar-cliente.php?id=<?php echo $data['id_cliente']; ?>">Eliminar</a>
                </td>
              </tr>
              <?php
                }
