    ...
    <div class="lista-f">
      ...
      <table>
        ...
        <?php
            ...
            $query = mysqli_query($conexion, "SELECT o.id_producto, o.nombre_producto, o.precio, p.nombre, p.apellido
                                              FROM productos o
            ...
            ?>
              <tr>
                ...
                <td>
                  <a href="actualizar-producto.php?id=<?php echo $data['id_producto']; ?>">Actualizar</a> |
                  <a href="eliminar-producto.php?id=<?php echo $data['id_producto']; ?>">Eliminar</a>
                </td>
              </tr>
              <?php
                }
